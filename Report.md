...
since P(s<sup>1|s; a<sub>1<\sub>,...., a<sub>N<\sub>, π<sub>1<\sub>,...., π<sub>N<\sub>) = P(s <sup>'<\sup> |s, a<sub>1<\sub>,….,a<sub>N<\sub>) = P(s<sup>`<\sup>|s; a<sub>1<\sub>,….,a<sub>N<\sub>;π<sub>1<\sub>,…..,π<sub>N<\sub>)
